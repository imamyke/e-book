...
export const removeFromBookShelf = (book) => {
...
export const flatBookList = (bookList) => {
  if (bookList) {
...
export const gotoBookDetail = (vue, book) => {
  vue.$router.push({
    path: '/store/detail',
    query: {
